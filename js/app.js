  /*jshint loopfunc:true */ // ignore the message 'Don't make functions within a loop.'
  var model = {
    //Store App Data
  ...
  var viewModel = function() {
    ...
    menutButton.addEventListener('click', shownMenu);
        ...
        xhttp.onreadystatechange = function() {
          if (this.responseText) {
            ...
            infowindow.setContent('<div class="place"><img src="' + obj.response.venue.bestPhoto.prefix + '200x200' + obj.response.venue.bestPhoto.suffix + '"></img><br>' +
              ...
              '<p>' + obj.response.venue.rating + '</P></div>');
            clicked = marker;
    ...
    // to show/hide the menu div
    function shownMenu() {
      var checkVisibility = document.getElementById('menu').style.visibility;
      if (checkVisibility == 'hidden') {
  ...
  window.initMap = function() { // prevent the Uncaught InvalidValueError: initMap is not a function
